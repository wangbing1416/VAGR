...
def parse_args():
    ...
    parser.add_argument('--data_dir', help='TACRED directory.', default="../VAGR/dataset/Tweets_corenlp")
    parser.add_argument('--vocab_dir', help='Output vocab directory.', default="../VAGR/dataset/Tweets_corenlp")
